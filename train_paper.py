...
def main():
    ...
    ap.add_argument("--num-puzzle-tokens", type=int, default=0, help="N-Queens default follows Table 6's Puzzle Emb off; use 16 as an ablation.")
